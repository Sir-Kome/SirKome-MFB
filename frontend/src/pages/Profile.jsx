      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 xl:flex-row"><Sidebar /><main className="flex-1 space-y-4"><Navbar user={user} />
        <div className="grid gap-4 2xl:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[28px] border border-slate-200/70 bg-white/85 p-6 shadow-lg backdrop-blur">
            ...
            <div className="mt-4 flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3"><div><p className="text-xs uppercase tracking-wide text-slate-500">Account number</p><p className="mt-1 font-semibold text-slate-900">{user.account_number || 'Not available'}</p></div><AccountNumberCopy accountNumber={user.account_number} /></div>
